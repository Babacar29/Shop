...
class _AuthCardState extends State<AuthCard>  with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _slideAnimation = Tween<Offset>(begin: Offset(0, -1.5), end:  Offset(0, 0)).animate(CurvedAnimation(parent: _animationController, curve: Curves.linear));
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    FlatButton(
                      child: Text(_authMode == AuthMode.Signup ? 'LOGIN INSTEAD' : 'SIGNUP INSTEAD'),
